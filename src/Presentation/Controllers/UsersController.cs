...
//    [ProducesResponseType(StatusCodes.Status422UnprocessableEntity, Type = typeof(IReadOnlyDictionary<string, string[]>))]
//    [ProducesResponseType(StatusCodes.Status404NotFound)]
//    public async Task<IActionResult> UpdateUserAsync(string id, UserForUpdateDto userForUpdateDto)
//    {
...
//    [ProducesResponseType(StatusCodes.Status422UnprocessableEntity, Type = typeof(IReadOnlyDictionary<string, string[]>))]
//    [ProducesResponseType(StatusCodes.Status404NotFound)]
//    public async Task<IActionResult> PartiallyUpdateUserAsync(string id,
